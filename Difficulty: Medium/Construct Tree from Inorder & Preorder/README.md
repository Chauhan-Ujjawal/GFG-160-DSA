...
<p><span style="font-size: 14pt;"><strong>Note:</strong> The inorder and preorder traversals contain unique values, and every value present in the preorder traversal is also found in the inorder traversal.</span></p>
...
<p><span style="font-size: 14pt;"><strong style="font-size: 14pt;">Constraints:</strong><br><span style="font-size: 14pt;">1 ≤ number of nodes ≤ 10</span><sup style="font-size: 14pt;">3</sup><br><span style="font-size: 18.6667px;">0 ≤ inorder[i], preorder[i] ≤ 10</span><sup style="font-size: 18.6667px;">6</sup></span></p>
